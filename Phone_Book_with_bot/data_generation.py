...
ls_name = ['Sergey', 'Oleg', 'Andrey', 'Anna', 'Igor',
           'Viktoriya', 'Vasiliy', 'Alexey', 'Marina', 'Rustam']
ls_surname = ['Kovalev', 'Sidorov', 'Mironov',
              'Galimardanov', 'Shapirov', 'Pegas', 'Pegas', 'Shagar', 'Morozic']
